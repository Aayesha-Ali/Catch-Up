...
function AddFriendProfile (props) {
  ...
  return (
    <View>
      ...
      <Text style= {{fontSize: 40, fontWeight: 'bold', textAlign: 'center', marginTop: 20}}>{user.username}</Text>
      <Text style= {{fontSize: 20, fontWeight: 'bold', textAlign: 'center', marginTop: 10, marginBottom: 20, fontStyle: "italic",}}>{user.firstName} {user.lastName}</Text> 
